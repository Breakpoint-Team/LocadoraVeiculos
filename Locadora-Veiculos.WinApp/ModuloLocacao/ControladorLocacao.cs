...
namespace Locadora_Veiculos.WinApp.ModuloLocacao
{
    public class ControladorLocacao : ControladorBase
    {
        ...
        public override void Inserir()
        {
            ...
            {
                MessageBox.Show("Relatório PDF da Locação gerado com sucesso!",
                "Inserção de Locação", MessageBoxButtons.OK, MessageBoxIcon.Information);
                CarregarLocacoes();
            }
        }
        ...
        public void DevolverLocacao()
        {
            ...
            if (tela.ShowDialog() == DialogResult.OK)
            {
                MessageBox.Show("Relatório PDF da devolução gerado com sucesso!",
                "Devolução de Locação", MessageBoxButtons.OK, MessageBoxIcon.Information);
                CarregarLocacoes();
